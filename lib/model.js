...
Model.prototype.validate = function(){
  ...
  this.link.observed.forEach(function(s, i){
    ...
    if(!Array.isArray(s.time_series_id)){
      ...
      function isSameType(el, i, array){
        return el.split('__')[2] === array[0].split('__')[2];
      }
      if(! s.time_series_id.every(isSameType)){
    ...
    s.definition.forEach(function(r){
      ...
      //TODO REDO THAT PART (brainfuck) USING obsType infered above
      var obsType= '';
      if(typeof r === 'string'){
